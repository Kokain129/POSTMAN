...
HW2 11.05.2022
	...
	I http://162.55.220.72:5005/first

1. Отправить запрос.
2. Статус код 200
3. Проверить, что в body приходит правильный string.

	II http://162.55.220.72:5005/user_info_3
...
12. Проверить что u_salary_1_5_year в ответе равно salary*4 (salary забрать из request)
	...
	III http://162.55.220.72:5005/object_info_3
...
12. Проверить, что параметр age имеет значение 4.
	...
	IV http://162.55.220.72:5005/object_info_4
...
21. Написать цикл который выведет в консоль по порядку элементы списка из параметра salary.
	...
	V http://162.55.220.72:5005/user_info_2
...
Умножь salary на 3.3 и проверь что оно равно salary1,5

// jsonData["qa_salary_after_1.5_year"]
